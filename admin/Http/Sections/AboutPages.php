...
use App\Models\AboutPage as PageModel;


class AboutPages extends Section implements Initializable
{
    /**
     * @var bool
     */
...
//        });
    ...
    public function onEdit($id)
    {
        ...
        $display->addBody([
            ...
            AdminFormElement::text(';', 'Описание')->required(),
