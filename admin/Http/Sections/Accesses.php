...
use App\Models\Access as PageModel;


class Accesses extends Section implements Initializable
{
    /**
     * @var bool
     */
...
//        });
    ...
    public function onDisplay()
    {
        ...
        $display->setHtmlAttribute('class', 'table-primary')
            ->setColumns(
                ...
                AdminColumn::text('days', 'Количество дней'),
    ...
    public function onEdit()
    {
        ...
        $display->addBody([
            ...
            AdminFormElement::text('days', 'Количество дней')->required(),
